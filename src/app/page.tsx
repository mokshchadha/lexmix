...
import { Gavel, Scale, ShieldCheck, HeartHandshake, Clock, Users, Lock, ChevronRight } from "lucide-react";
        ...
        <section className="relative overflow-hidden pt-16 pb-24 lg:pt-32 lg:pb-40">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="mx-auto max-w-3xl text-center">
              <div className="mb-6 inline-flex items-center rounded-full border border-black/10 bg-black/5 px-3 py-1 text-sm font-medium text-zinc-800 dark:border-white/10 dark:bg-white/10 dark:text-zinc-200">
                <span className="flex h-2 w-2 rounded-full bg-black dark:bg-white mr-2"></span>
                Exclusive for Indian Legal Professionals
              </div>
              <h1 className="font-serif text-5xl font-bold tracking-tight text-black dark:text-white sm:text-7xl mb-8">
                Balance the Scales of <span className="italic relative z-10">Life & Law</span>
              </h1>
              <p className="mx-auto max-w-2xl text-lg text-zinc-600 dark:text-zinc-400 mb-10">
                 The first vertically integrated ecosystem designed exclusively for verified lawyers, judges, and legal scholars. Find a partner who understands the sidebar.
              </p>
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <WaitlistForm 
                  ...
                  triggerText={<>Join Waitlist <ChevronRight className="ml-2 h-4 w-4" /></>}
                />
                <Link
                  href="#problem"
          ...
          <div className="absolute top-0 left-0 -z-10 h-full w-full bg-[radial-gradient(#e5e7eb_1px,transparent_1px)] [background-size:16px_16px] [mask-image:radial-gradient(ellipse_50%_50%_at_50%_50%,#000_70%,transparent_100%)] dark:bg-[radial-gradient(#27272a_1px,transparent_1px)]"></div>
        </section>
